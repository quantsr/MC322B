...
public class ClientePJ extends Cliente{
	...
	public ClientePJ(String cnpj, Date dataFundacao, int qtdeFuncionarios) {
		super();
		this.cnpj = cnpj;
		this.dataFundacao = dataFundacao;
		this.qtdeFuncionarios = qtdeFuncionarios;
	}
	public ClientePJ(String cnpj, Date dataFundacao, int qtdeFuncionarios, String nome, String endereco, LinkedList <Veiculo> listaVeiculos) {
	...
	public double calculaScore() {
			return CalcSeguro.VALOR_BASE.value * (1 + (this.qtdeFuncionarios)/100) * this.getListaVeiculo().size();
	}
